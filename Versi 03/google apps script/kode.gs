 ...
 * ***********************************************************************************
 * Code by    : Tasya Arcinta
 * Contact me : Tasyaarcinta98@gmail.com
 * YouTube    : https://www.youtube.com/c/Tasya Arcinta
 * Github     : https://github.com/Tasyaarcinta
 * Date       : Jul 2021
 * License    : MIT
 */
...
// --------------------------------------------------------------------------------------------------------------------
var idGambarLogo    = '1BGExpEPOFH7WLk7tMhNBsKbdYJ9S3gsv'; // id file logo di google drive
var idDataPegawai   = '1bZ31YeGVoSE42ssGTPmFNAiUc6e9AA_w6EF3cEalsiA'; // id file spreadsheet
var idFolderAbsensi = '1wK5TxPTqza2MRq_RURkvLqEi1grTfkVe'; // id folder absensi
var namaPerusahaan  = 'Tasya Arcinta co, ltd';

// koordinat [lat,lon] --> koordinat bisa diambil dari google map (cek video di channel youtube saya)
var lokasiPerusahaan = [3.618202718760124, 98.7314323662714]; 
